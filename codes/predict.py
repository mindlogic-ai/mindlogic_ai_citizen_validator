from src.model import ElectraRecommendClassifier
...
def get_parameters():
    ...
    parser.add_argument('-i', '--input_text', help = 'user input text.', default = '철수[SEP]안녕하세요 반가워요 제 이름은 철수에요![SEP]', type = str)
    parser.add_argument('-b', '--base_ckpt', help = 'base path that will be saved trained checkpoints.', default = False, type = str)
...
## 나중에 바꾸든가 해야 함
tokenizer = ElectraTokenizer.from_pretrained('mindlogic/mindlogic-electra-ko-ai-citizen-classifier-base')
